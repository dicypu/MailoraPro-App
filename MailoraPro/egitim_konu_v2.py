"""
Mailora AI — Konu Modeli v2 Eğitimi (12 Kategori, GPU ZORUNLU)
...
Çalıştır: python egitim_konu_v2.py
"""
...
CIKIS_KLASORU = "./Modeller/Konu_Modeli_v2"
VERI_DOSYASI = "./VeriSetleri/email_konu_v2.csv"
MAX_UZUNLUK = 128
...
print(Fore.CYAN + "=" * 60)
print(Fore.CYAN + f"🚀 KONU MODELİ v2 EĞİTİMİ — {len(KATEGORILER)} KATEGORİ")
...
if not pd.io.common.file_exists(VERI_DOSYASI):
    ...
    print(Fore.RED + "Önce veri_olustur_v2.py çalıştırın!")
    exit(1)
...
print(Fore.GREEN + "=" * 60)
print(Fore.GREEN + "🎉 KONU MODELİ v2 HAZIR!")
